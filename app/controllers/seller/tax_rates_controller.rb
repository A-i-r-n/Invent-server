module Seller
  class TaxRatesController < Seller::ApplicationController
    ...
    def create
      ...
      if @tax_rate.save
        redirect_to [:seller,:tax_rates], flash: { notice: t('shoppe.tax_rates.create_notice') }
      else
        render action: 'form'
      end
    end
    ...
    def update
      if @tax_rate.update(safe_params)
        redirect_to [:edit,:seller, @tax_rate], flash: { notice: t('shoppe.tax_rates.update_notice') }
      else
        render action: 'form'
      end
    end
