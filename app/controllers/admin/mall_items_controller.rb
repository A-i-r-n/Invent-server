module Admin
  class MallItemsController < Admin::BaseController
    ...
    def safe_params
      ...
      params[:mall_item].permit(:name,:type,:price,:periods, :max_periods, :participants, :max_participants, :description, :status,:end_time, attachments: [default_image: file_params, data_sheet: file_params, extra: file_params])
    end
  end
end
