module Admin
  class DeliveryServicePricesController < Admin::ApplicationController
    ...
    def update
      if @delivery_service_price.update(safe_params)
        redirect_to [:admin , @delivery_service, :delivery_service_prices], notice: t('shoppe.delivery_service_prices.update_notice')
      else
        render action: 'edit'
      end
    end
    ...
    def destroy
      ...
      redirect_to [:admin ,@delivery_service, :delivery_service_prices], notice: t('shoppe.delivery_service_prices.destroy_notice')
    end
