  ...
  class ProductCategoriesController < Admin::BaseController
    ...
    def create
      ...
      if @product_category.save
        redirect_to [:admin,:product_categories], flash: { notice: t('shoppe.product_category.create_notice') }
      else
        render action: 'new'
      end
    end
    ...
    def update
      if @product_category.update(safe_params)
        redirect_to [:edit,:admin, @product_category], flash: { notice: t('shoppe.product_category.update_notice') }
      else
        render action: 'edit'
      end
    end
    ...
    def destroy
      ...
      redirect_to [:admin,:product_categories], flash: { notice: t('shoppe.product_category.destroy_notice') }
    end
