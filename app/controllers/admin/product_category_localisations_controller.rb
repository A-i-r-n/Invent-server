require 'globalize'
module Admin
  class ProductCategoryLocalisationsController < Admin::ApplicationController
    ...
    def update
      if @localisation.update(safe_params)
        redirect_to [:admin, @product_category, :localisations], notice: t('shoppe.localisations.localisation_updated')
      else
        render action: 'form'
      end
    end
